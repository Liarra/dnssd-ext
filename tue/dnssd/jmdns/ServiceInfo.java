...
public abstract class ServiceInfo implements Cloneable {
    ...
    /**
     * Add context tags to this service info.
     * @param tags
     */
    public abstract void addTags(Collection<String> tags);

    /**
     * Remove context tags to this service info.
     * @param tags
     */
    public abstract void removeTags(List<String> tags);

    /**
     * Checks if this service has ALL of these context tags.
     * @param str
     * @return
     */
    public abstract boolean hasTags(String str);

    public abstract Set<String> getTags();

    /**
     * Set the naming scheme for this service. Helps to resolve services in lazy mode. Better call this one before
     * actually publishing the service.
     * @param namingScheme
     */
    public abstract void set_namingSchemePublishedUnder(NamingScheme namingScheme);
