...
public abstract class JmDNS implements Closeable {
    ...
    /**
     * Sends out specified records to be accessible by other network members. Adds records to own internal storage.
     * @param entries
     * @throws IOException
     */
    public abstract void publishDNSRecords(List<DNSRecord> entries) throws IOException;

    public abstract void subscribeForRecordUpdates(DNSEntry entry, DNSListener recordUpdatedListener);
    public abstract void unsubscribeForRecordUpdates(DNSEntry entry, DNSListener recordUpdatedListener);
    public abstract void sendmDNSMessage(DNSOutgoing outgoing) throws IOException;
