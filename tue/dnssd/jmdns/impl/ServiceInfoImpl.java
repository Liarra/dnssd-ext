...
package tue.dnssd.jmdns.impl;

import tue.dnssd.context.tag.naming.FormulaNamingScheme;
...
import tue.dnssd.jmdns.impl.DNSRecord.Pointer;
import tue.dnssd.jmdns.impl.DNSRecord.Service;
import tue.dnssd.jmdns.impl.DNSRecord.Text;
import tue.dnssd.jmdns.impl.constants.DNSRecordClass;
import tue.dnssd.jmdns.impl.constants.DNSRecordType;
import tue.dnssd.jmdns.impl.constants.DNSState;
import tue.dnssd.jmdns.impl.tasks.DNSTask;
...
public class ServiceInfoImpl extends ServiceInfo implements DNSListener, DNSStatefulObject {
    ...
    private NamingScheme            _namingSchemePublishedUnder;
    ...
    private Set<String> tags=new HashSet<String>(16);
    ...
    //TODO: This is quickfix, should rewrite it
    public boolean hasTags(String str){
        Set<String> tagsStringsSet;
        if(_namingSchemePublishedUnder==null) {
            return false;
        }
        else if (_namingSchemePublishedUnder instanceof FormulaNamingScheme){
            return ((FormulaNamingScheme) _namingSchemePublishedUnder).isSatisfying(str,this.getTypeWithSubtype(),tags);
        }
        else{
            tagsStringsSet=_namingSchemePublishedUnder.getTagsForString(str,this.getTypeWithSubtype());
        }

        boolean b=true;
        for (String tagsString : tagsStringsSet) {
            b &= tags.contains(tagsString);
        }
    ...
    public void set_namingSchemePublishedUnder(NamingScheme _namingSchemePublishedUnder) {
        this._namingSchemePublishedUnder = _namingSchemePublishedUnder;
    }
     ...
     * @param persistent
     * @param text
     * @see tue.dnssd.jmdns.ServiceInfo#create(String, String, int, int, int, String)
     */
     ...
     * @param persistent
     * @param props
     * @see tue.dnssd.jmdns.ServiceInfo#create(String, String, int, int, int, Map)
     */
     ...
     * @param persistent
     * @param text
     * @see tue.dnssd.jmdns.ServiceInfo#create(String, String, int, int, int, byte[])
     */
...
//                index = aType.indexOf('.');
    ...
    /**
     * @see tue.dnssd.jmdns.ServiceInfo#getServer()
     */
    @Override
    ...
    /**
     * @see tue.dnssd.jmdns.ServiceInfo#getPort()
     */
    @Override
    public int getPort() {
        return _port;
    ...
    /**
     * @see tue.dnssd.jmdns.ServiceInfo#getPriority()
     */
    @Override
    ...
    /**
     * @see tue.dnssd.jmdns.ServiceInfo#getWeight()
     */
    @Override
    ...
    /**
     * @see tue.dnssd.jmdns.ServiceInfo#getTextBytes()
     */
    @Override
